...
import static io.microsphere.spring.redis.beans.Wrapper.tryUnwrap;
import static io.microsphere.spring.redis.metadata.RedisMetadataRepository.findWriteCommandMethod;
import static io.microsphere.spring.redis.metadata.RedisMetadataRepository.getRedisCommandBindingFunction;
