 ...
 * @since 1.0.0
 */
public class DefaultResourceComparatorTest {
    ...
    @Test
    public void testCompareWithDifferentFilenames() {
        FileSystemResource r1 = new FileSystemResource("/tmp/a.txt");
        FileSystemResource r2 = new FileSystemResource("/tmp/b.txt");
        assertTrue("a.txt should come before b.txt", comparator.compare(r1, r2) < 0);
        assertTrue("b.txt should come after a.txt", comparator.compare(r2, r1) > 0);
    }

    @Test
    public void testCompareWithEqualFilenames() {
        ...
        assertEquals("Same filename should compare as equal", 0, comparator.compare(r1, r2));
    }

    @Test
    public void testCompareOrdering() {
