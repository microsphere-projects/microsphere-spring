...
class YamlPropertySourceFactoryTest {
    ...
    void testCreatePropertySource() throws IOException {
        ClassPathResource resource = new ClassPathResource("META-INF/test/yaml/1.yaml");
        EncodedResource encodedResource = new EncodedResource(resource);

        PropertySource<?> propertySource = factory.createPropertySource("testYaml", encodedResource);
