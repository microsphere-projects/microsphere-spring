 ...
 * @since 1.0.0
 */
public class EnableAutoRegistrationBeanTest {
    ...
    @Test
    public void testDisabledTest1Config() {
        testInSpringContainer(context -> {
    ...
    @Test
    public void testDisabledTest2Config() {
        testInSpringContainer(context -> {
    ...
    @Test
    public void testDisabledAllConfig() {
        testInSpringContainer(context -> {
    ...
    @Test
    public void testDuplicatedConfig() {
        testInSpringContainer(context -> {
