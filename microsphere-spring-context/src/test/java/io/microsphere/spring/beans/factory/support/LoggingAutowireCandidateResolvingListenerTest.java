 ...
 * @since 1.0.0
 */
public class LoggingAutowireCandidateResolvingListenerTest {
    ...
    @Test
    public void testSuggestedValueResolvedWithNonNullValue() {
    ...
    @Test
    public void testSuggestedValueResolvedWithNullValue() {
        DependencyDescriptor descriptor = new DependencyDescriptor(findField(getClass(), "testField"), false);
    ...
    @Test
    public void testLazyProxyResolvedWithNonNullProxy() {
        DependencyDescriptor descriptor = new DependencyDescriptor(findField(getClass(), "testField"), false);
        // Should not throw
    ...
    @Test
    public void testLazyProxyResolvedWithNullProxy() {
        DependencyDescriptor descriptor = new DependencyDescriptor(findField(getClass(), "testField"), false);
