 ...
 * @since 1.0.0
 */
public class CompositeAutowireCandidateResolvingListenerTest {
    ...
    @Test
    public void testSuggestedValueResolvedDelegatesToAllListeners() {
        ...
        CompositeAutowireCandidateResolvingListener composite =
                new CompositeAutowireCandidateResolvingListener(ofList(l1, l2));
    ...
    @Test
    public void testLazyProxyResolvedDelegatesToAllListeners() {
        AtomicInteger callCount = new AtomicInteger(0);
        AutowireCandidateResolvingListener l1 = new AutowireCandidateResolvingListener() {
            @Override
