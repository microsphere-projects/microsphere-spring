...
import static io.github.microsphere.spring.util.BeanUtils.*;
...
public class BeanUtilsTest {
    ...
    public void testGetBeanNames() {
        ...
        beanNames = getBeanNames(listableBeanFactory, io.github.microsphere.spring.util.Bean.class, true);
        ...
        beanNames = getBeanNames(beanFactory, io.github.microsphere.spring.util.Bean.class, true);
        ...
        beanNames = getBeanNames(beanFactory, io.github.microsphere.spring.util.Bean.class);
    ...
    public void testGetOptionalBeanExcludingAncestors() {
        ...
        List<io.github.microsphere.spring.util.Bean> beans = BeanUtils.getSortedBeans(registry, io.github.microsphere.spring.util.Bean.class);
