...
/**
 * The interface listens the manipulation of {@link ConfigurableEnvironment} is composited by {@link ProfileListener}
 *
...
public interface EnvironmentListener extends ProfileListener, PropertyResolverListener {
     ...
     *
     * @param environment       current {@link ConfigurableEnvironment}
