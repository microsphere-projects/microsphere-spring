...
import static io.microsphere.spring.redis.metadata.RedisMetadataRepository.findMethodIndex;
import static io.microsphere.spring.redis.metadata.RedisMetadataRepository.findRedisCommandMethod;
import static io.microsphere.spring.redis.metadata.RedisMetadataRepository.findWriteCommandMethod;
import static io.microsphere.spring.redis.serializer.RedisCommandEventSerializer.VersionedRedisSerializer.valueOf;
import static io.microsphere.spring.redis.util.RedisCommandsUtils.resolveInterfaceName;
import static io.microsphere.spring.redis.util.RedisCommandsUtils.resolveSimpleInterfaceName;
