...
/**
 * {@link EnableWebFluxExtension} Test when all status are enabled with test cases :
 * <ul>
 ...
 *     <li>All {@link HandlerMethodArgumentInterceptor} or {@link HandlerMethodInterceptor} bean will be registered and
 ...
 *     <li>The {@link RequestContextWebFilter} with {@link InheritableThreadLocal} bean will be registered</li>
 *     <li>All {@link RequestBody} method arguments of {@link Controller Controllers} will be stored</li>
 *     <li>All {@link ResponseBody} method return values of {@link Controller Controllers} will be stored</li>
 *     <li>The {@link ReversedProxyHandlerMapping} bean will be registered</li>
 * </ul>
 *
...
@ContextConfiguration(classes = {
        EnableWebFluxExtensionAllEnabledTest.class
})
...
class EnableWebFluxExtensionAllEnabledTest extends AbstractEnableWebFluxExtensionTest {
}