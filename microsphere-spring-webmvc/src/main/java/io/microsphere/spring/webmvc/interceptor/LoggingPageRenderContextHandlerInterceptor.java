...
/**
 * {@link AbstractPageRenderContextHandlerInterceptor} for logging
 *
...
public class LoggingPageRenderContextHandlerInterceptor extends AbstractPageRenderContextHandlerInterceptor {
    ...
    private static final Logger logger = getLogger(LoggingPageRenderContextHandlerInterceptor.class);
