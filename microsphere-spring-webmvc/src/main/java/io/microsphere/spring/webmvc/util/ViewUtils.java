...
public abstract class ViewUtils implements Utils {
    ...
    /**
     * Get the {@link HttpStatusCode} for the {@link View}
     *
     * @param requestAttributes the {@link RequestAttributes}
     * @return the {@link HttpStatusCode} if set, otherwise {@code null}
     * @see View#RESPONSE_STATUS_ATTRIBUTE
     */
    @Nullable
    public static HttpStatusCode getResponseStatus(RequestAttributes requestAttributes) {
