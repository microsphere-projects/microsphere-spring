...
/**
 * {@link EnableWebMvcExtension} Test on disabled status(all attributes are <code>false</code>).
 *
...
@ContextConfiguration(classes = {
        EnableWebMvcExtensionTestOnDisabled.class
})
...
public class EnableWebMvcExtensionTestOnDisabled extends AbstractEnableWebMvcExtensionTest {
}